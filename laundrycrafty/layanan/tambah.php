...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO layanan (nama_layanan, harga_per_kg, deskripsi, durasi_hari) 
            VALUES ('$nama_layanan', '$harga_per_kg', '$deskripsi', '$durasi_hari')";
    
    if ($conn->query($sql)) {
        // Log activity
        logActivity('add_layanan', "Menambahkan layanan baru: {$nama_layanan}");
        
        flashMessage('success', 'Layanan berhasil ditambahkan!');
...
<head>
    ...
    <title>Tambah Layanan - LaundryCrafty</title>
    ...
    <div class="main-content">
        ...
        <div class="top-bar">
            <div class="page-title">
                <h4><i class="fas fa-plus-circle me-2"></i>Tambah Layanan</h4>
                <nav class="breadcrumb">
                    <a href="../index.php">Dashboard</a> / <a href="list.php">Layanan</a> / Tambah
                </nav>
            </div>
        </div>
        ...
        <div class="form-card">
            <div class="form-header">
                ...
                <h4>Form Tambah Layanan Baru</h4>
            </div>
            ...
            <form method="POST" action="">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="harga_per_kg" class="form-control" placeholder="5000" min="0" step="100" required>
                </div>

                <div class="form-group">
                    <label class="form-label"><i class="fas fa-clock me-2"></i>Durasi Pengerjaan (Hari)</label>
                    <input type="number" name="durasi_hari" class="form-control" value="3" min="1" max="30" required>
                </div>

                <div class="form-group">
                    <label class="form-label"><i class="fas fa-align-left me-2"></i>Deskripsi Layanan</label>
                    <textarea name="deskripsi" class="form-control" rows="4" placeholder="Jelaskan detail layanan ini..."></textarea>
                </div>
